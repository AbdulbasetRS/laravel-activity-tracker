    ...
    <div class="at-shell">
        <aside class="at-sidebar" data-at-sidebar>
            ...
            <nav class="at-nav">
                ...
                <a href="{{ route('activity-tracker.authentication') }}" class="at-nav-link {{ request()->routeIs('activity-tracker.authentication') ? 'is-active' : '' }}">
                ...
                <a href="{{ route('activity-tracker.broadcasts') }}" class="at-nav-link {{ request()->routeIs('activity-tracker.broadcasts*') ? 'is-active' : '' }}">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M4.9 19.1a10 10 0 010-14.2M19.1 4.9a10 10 0 010 14.2M7.8 16.2a5 5 0 010-8.4M16.2 7.8a5 5 0 010 8.4"/><circle cx="12" cy="12" r="1.5" fill="currentColor" stroke="none"/></svg>
                    Broadcasts
                </a>
